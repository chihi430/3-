package com.study.android.pchsns.chat_fragment;
...
import com.study.android.pchsns.NewPostActivity;
...
public class UserListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        final TextView curent_user_name = view.findViewById(R.id.curent_user_name);
        final TextView curent_user_msg = view.findViewById(R.id.curent_user_msg);
        final ImageView curent_user_image = view.findViewById(R.id.curent_user_photo);
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                curent_user_name.setText(userModel.getUsernm());
                curent_user_msg.setText(userModel.getUsermsg());

                Glide.with(getActivity())
                        .load(FirebaseStorage.getInstance().getReference("userPhoto/"+userId))
                        .apply(requestOptions)
                        .error(R.drawable.user)
                        .into(curent_user_image);
    ...
    class RecyclerViewAdapter extends FirestoreAdapter<CustomViewHolder> {
        ...
        RecyclerViewAdapter(Query query) {
            ...
            storageRef = storage.getReferenceFromUrl("gs://argon-potential-251100.appspot.com");
        ...
        public void onBindViewHolder(CustomViewHolder viewHolder, int position) {
            ...
            Log.d("ㅎㅇㅎㅇ", "userchat 다야 "+user.getUserphoto());
            if (user.getUserphoto()==null) {
                ...
                Glide.with(getActivity())
                        .load(storageRef.child("userPhoto/"+user.getUserphoto()))
                        .apply(requestOptions)
                        .into(viewHolder.user_photo);
            }
